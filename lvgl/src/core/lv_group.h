...
typedef int (*lv_group_user_focus_check_cb_t)(struct _lv_group_t *);
/**
 * This function allows the user to register a custom check for focus management.
 * It returns 1 if the focus handling should be exclusively managed by the user,
 * or 0 if the default focus handling should continue.
 */
...
typedef struct _lv_group_t {
    ...
    lv_group_user_focus_check_cb_t user_check_cb;     /**< User-defined function to check and manage focus. */
...
/**
 * Set a function for a group which will be called when a new user object is focused
 * @param group         pointer to a group
...
/**
 * Get the user focus callback function of a group
 * @param group pointer to a group
