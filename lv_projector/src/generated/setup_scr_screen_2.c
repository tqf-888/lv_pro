...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    //Write codes screen_2_btn_16
    ui->screen_2_btn_16 = lv_btn_create(ui->screen_2);
    ui->screen_2_btn_16_label = lv_label_create(ui->screen_2_btn_16);
    lv_label_set_text(ui->screen_2_btn_16_label, "收藏MV");
    lv_label_set_long_mode(ui->screen_2_btn_16_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_2_btn_16_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_2_btn_16, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_2_btn_16_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_2_btn_16, 1150, 36);
    lv_obj_set_size(ui->screen_2_btn_16, 100, 50);

    //Write style for screen_2_btn_16, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_16, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_16, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_2_btn_16, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_2_btn_16, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_2_btn_16, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_2_btn_16, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_2_btn_16, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_2_btn_16, &lv_font_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_2_btn_16, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
