...
void setup_scr_screen_102(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->screen_102, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_102_img_2, 0, 0);
    lv_obj_set_size(ui->screen_102_img_2, 1280, 800);
    ...
    lv_obj_set_pos(ui->screen_102_btn_1, 940, 83);
    ...
    lv_obj_set_pos(ui->screen_102_img_1, 26, 25);
    ...
    lv_obj_set_pos(ui->screen_102_btn_3, 3, 0);
    ...
    //Write codes screen_102_cont_1
    ui->screen_102_cont_1 = lv_obj_create(ui->screen_102);
    lv_obj_set_pos(ui->screen_102_cont_1, 326, 210);
    lv_obj_set_size(ui->screen_102_cont_1, 894, 527);
    lv_obj_set_scrollbar_mode(ui->screen_102_cont_1, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_102_cont_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_102_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_102_btn_4
    ui->screen_102_btn_4 = lv_btn_create(ui->screen_102);
    ui->screen_102_btn_4_label = lv_label_create(ui->screen_102_btn_4);
    lv_label_set_text(ui->screen_102_btn_4_label, "");
    lv_label_set_long_mode(ui->screen_102_btn_4_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_102_btn_4_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_102_btn_4, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_102_btn_4_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_102_btn_4, 36, 188);
    lv_obj_set_size(ui->screen_102_btn_4, 240, 505);

    //Write style for screen_102_btn_4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_102_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_102_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_102_btn_4, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_102_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_102_btn_4, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_102_btn_4, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_102_btn_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_102_btn_4, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
