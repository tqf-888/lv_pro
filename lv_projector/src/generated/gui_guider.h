...
typedef struct
{
	...
	lv_obj_t *screen_log_in_btn_6;
	lv_obj_t *screen_log_in_btn_6_label;
	lv_obj_t *screen_log_in_btn_7;
	lv_obj_t *screen_log_in_btn_7_label;
	lv_obj_t *screen_2;
	bool screen_2_del;
	...
	lv_obj_t *screen_102_cont_1;
	lv_obj_t *screen_102_btn_4;
	lv_obj_t *screen_102_btn_4_label;
	lv_obj_t *screen_103;
	bool screen_103_del;
...
LV_IMG_DECLARE(_sgderhbrdsdfgs_alpha_82x82);
LV_IMG_DECLARE(_vsdgvdsbvghg8_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg14_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg7_alpha_220x56);
LV_IMG_DECLARE(_vsdgvdsbvghg15_alpha_220x56);
LV_IMG_DECLARE(_vsdgvdsbvghg10_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg13_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg11_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg12_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg9_alpha_220x60);
LV_IMG_DECLARE(_vsdgvdsbvghg5_alpha_220x60);
LV_IMG_DECLARE(_dhbdhnbfd_alpha_420x431);
