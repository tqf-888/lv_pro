#ifndef LV_COVER_VIEW_STYLE_H
#define LV_COVER_VIEW_STYLE_H
...
typedef struct {
    ...
    lv_cover_row_style_t row_style;
} lv_cover_view_style_t;

extern lv_cover_view_style_t g_lv_cover_default_style;
void lv_cover_default_style_init(void);
