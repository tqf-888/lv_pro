#ifndef LV_FAVORITE_SONG_ADAPTER_H
#define LV_FAVORITE_SONG_ADAPTER_H
...
typedef struct {
    ...
    lv_favorite_song_catalog_t catalog;
...
/* 外部异步取数函数，由业务层实现 */
extern void fetch_favorite_song_batch(int batch_index);
