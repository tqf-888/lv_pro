#ifndef LV_RICH_SONG_VIEW_STYLE_H
#define LV_RICH_SONG_VIEW_STYLE_H
#ifdef __cplusplus
extern "C" {
#endif
#include "lvgl/lvgl.h"
...
typedef struct {
    ...
    lv_coord_t gap_x;
    lv_coord_t gap_y;
    lv_rich_song_row_style_t row_style;
} lv_rich_song_view_style_t;
extern lv_rich_song_view_style_t g_lv_rich_song_default_style;
