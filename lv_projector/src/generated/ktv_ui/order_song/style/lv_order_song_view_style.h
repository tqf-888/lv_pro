#ifndef LV_ORDER_SONG_VIEW_STYLE_H
#define LV_ORDER_SONG_VIEW_STYLE_H
#ifdef __cplusplus
extern "C" {
#endif
#include "lvgl/lvgl.h"
...
typedef struct {
    ...
    lv_coord_t gap_x;
    lv_coord_t gap_y;
    lv_order_song_row_style_t row_style;
} lv_order_song_view_style_t;
extern lv_order_song_view_style_t g_lv_order_song_default_style;
