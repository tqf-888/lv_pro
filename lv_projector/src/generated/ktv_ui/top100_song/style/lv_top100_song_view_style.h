#ifndef LV_TOP100_SONG_VIEW_STYLE_H
#define LV_TOP100_SONG_VIEW_STYLE_H
#ifdef __cplusplus
extern "C" {
#endif
#include "lvgl/lvgl.h"
...
typedef struct {
    ...
    lv_coord_t gap_x;
    lv_coord_t gap_y;
    lv_top100_song_row_style_t row_style;
} lv_top100_song_view_style_t;
extern lv_top100_song_view_style_t g_lv_top100_song_default_style;
