#ifndef LV_TOP100_SONG_DEBUG_H
#define LV_TOP100_SONG_DEBUG_H
...
/*
 * 日志总开关说明：
 * 1. LV_TOP100_SONG_ALLOC_LOG_ENABLE 控制内存申请/释放日志
 * 2. LV_TOP100_SONG_FLOW_LOG_ENABLE  控制普通流程日志
 * 3. LV_TOP100_SONG_HOT_LOG_ENABLE   控制高频路径日志（默认关闭，避免刷屏）
 *
 * 建议：
 ...
 * - 正式版本：三个都可改成 0
 */
#ifndef LV_TOP100_SONG_ALLOC_LOG_ENABLE
#define LV_TOP100_SONG_ALLOC_LOG_ENABLE 1
#endif

#ifndef LV_TOP100_SONG_FLOW_LOG_ENABLE
#define LV_TOP100_SONG_FLOW_LOG_ENABLE 1
#endif

#ifndef LV_TOP100_SONG_HOT_LOG_ENABLE
#define LV_TOP100_SONG_HOT_LOG_ENABLE 0
#endif

#define RS_LOG_PREFIX "[top100_song] "

#if LV_TOP100_SONG_FLOW_LOG_ENABLE
...
#if LV_TOP100_SONG_HOT_LOG_ENABLE
...
{
    void *p = malloc(size);
#if LV_TOP100_SONG_ALLOC_LOG_ENABLE
