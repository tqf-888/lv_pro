...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_log_in(ui);
    lv_scr_load(ui->screen_log_in);
}
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
}
