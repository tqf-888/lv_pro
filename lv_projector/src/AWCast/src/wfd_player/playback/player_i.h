...
enum EPLAYERINTERNALNOTIFY  //* player internal notify.
{
    ...
    PLAYER_VIDEO_RENDER_NOTIFY_PICTURE_PARAM,
...
#if defined(CONF_IPTV)
#define CONFIG_PLAYER_AUDIO_VIDEO_SYNC_START_STRATEGY           3
#else
...
#define CONFIG_THREASHOLD_OF_PTS_DIFFERENCE_TO_JUDGE_PTS_jUMP   (15000000)//(17000000)
 ...
 */
#define CONFIG_MAX_WAIT_TIME_FOR_SYNC                           (6000000)//(17000000)

// 20 seconds.
#define CONFIG_THREASHOLD_OF_PTS_DIFFERENCE_TO_JUDGE_PTS_jUMP_FOR_SUBTITLE (20000000)

#define CONFIG_AUDIO_RENDER_TIME_DELAY (500000) //TODO
#define CONFIG_VIDEO_FRAME_TIME_SMOOTH (200000) //TODO

#define TIMER_DROP_AUDIO_DATA       0x04
#define TIMER_DROP_VIDEO_DATA       0x05
#define TIMER_NEED_NOTIFY_AGAIN     0x06
#define TIMER_SMOOTH_VIDEO_DATA     0x07
