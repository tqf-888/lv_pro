 ...
 */
static inline int WFD_validFrameNum(StreamFifo *p)
{
    return (p->nWritePos - p->nReadPos + p->nMaxFrameNum) % p->nMaxFrameNum;
}

static inline int WFD_invalidFrameNumTooSmall(StreamFifo *p)
{
    int invalidFrameNum = p->nMaxFrameNum - WFD_validFrameNum(p);
...
**********************************************************************
*/
void WFD_StreamManagerDestroy(StreamManager *p)
{
    if (p == NULL)
        return;
...
**********************************************************************
*/
void WFD_StreamManagerReset(StreamManager* p)
{
    StreamFrame*      pFrame;
    int               nMaxFrameNum;
    //int               nReadPos;
...
**********************************************************************
*/
int WFD_StreamManagerBufferSize(StreamManager* p)
{
    if(p == NULL)
    {
        loge("p == NULL.");
...
**********************************************************************
*/
int WFD_StreamManagerStreamFrameNum(StreamManager* p)
{
    if(p == NULL)
    {
        loge("p == NULL.");
    ...
    return WFD_validFrameNum(&p->streamFifo);
}
...
**********************************************************************
*/
int WFD_StreamManagerStreamDataSize(StreamManager* p)
{
    if(p == NULL)
    {
        loge("p == NULL.");
...
**********************************************************************
*/
int WFD_StreamManagerRequestBuffer(StreamManager* p, int nRequireSize, char** ppBuf, int* pBufSize)
{
    ...
    *pBufSize = 0;
    ...
    if (WFD_invalidFrameNumTooSmall(&p->streamFifo))
    {
...
**********************************************************************
*/
int WFD_StreamManagerAddStream(StreamManager* p, StreamFrame* pStreamFrame)
{
...
**********************************************************************
*/
StreamFrame* WFD_StreamManagerRequestStream(StreamManager* p)
{
    ...
    if(WFD_validFrameNum(&p->streamFifo) == 0)
    {
...
**********************************************************************
*/
StreamFrame* WFD_StreamManagerGetFrameInfo(StreamManager* p, int nFrameIndex)
{
    StreamFrame*      pStreamFrame;
    int               nPos;
    ...
    if(nFrameIndex < 0 || nFrameIndex >= WFD_validFrameNum(&p->streamFifo))
    {
        pthread_mutex_unlock(&p->mutex);
        return NULL;
    }
...
**********************************************************************
*/
int WFD_StreamManagerReturnStream(StreamManager* p, StreamFrame* pStreamFrame)
{
    int               nReadPos;
...
int WFD_StreamManagerFlushStream(StreamManager* p, StreamFrame* pStreamFrame)
{
    (void)p;
    (void)pStreamFrame;
    return 0;
...
int WFD_StreamManagerRewind(StreamManager *p, int64_t curTime)
{
    ...
    for (n = 0; n < maxNum; n++)
    {
        if (llabs(curTime - fifo->pFrames[n].nPts) < minDiff)
        {
            find = n;
